...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _runAuth(Future<void> Function() request) async {
    if (_authBusy) return;
    ...
    try {
      ...
      AppLogger.error('SignUpScreen._runAuth', error, stackTrace);
      if (!mounted) return;
                      ...
                      FadeIn(
                        ...
                        child: SocialAuthButton(
                          ...
                          onPressed: _authBusy
                              ? null
                              : () => _runAuth(
                                    () => app.services.auth.signInWithApple(),
                                  ),
                        ),
                      ),
                      ...
                      FadeIn(
                        ...
                        child: SocialAuthButton(
                          ...
                          onPressed: _authBusy
                              ? null
                              : () => _runAuth(
                                    () => app.services.auth.signInWithGoogle(),
                                  ),
                        ),
                      ),
                      const SizedBox(height: 12),
                      ...
                      FadeIn(
                        ...
                        child: DisciplineTextButton(
                          ...
                          onPressed: _authBusy
                              ? null
                              : () => _runAuth(
                                    () => app.services.auth.signInAnonymously(),
                                  ),
                          color: DisciplineColors.textSecondary,
                        ),
                      ),
