              ...
              DisciplineButton(
                ...
                onPressed: () {
                  ...
                  final group = CommunityGroup(
                    ...
                    name: _mode == _Mode.join ? 'Group $text' : text,
                    weeklyChangePercent: 12,
                    members: const <CommunityMember>[
                      CommunityMember(alias: 'Axiom-23', streakDays: 14),
                      CommunityMember(alias: 'North-8', streakDays: 9),
                      CommunityMember(alias: 'Cipher-11', streakDays: 21),
                      CommunityMember(alias: 'Vector-5', streakDays: 6),
                    ],
                  );
